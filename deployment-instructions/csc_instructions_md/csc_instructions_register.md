# Registering to CSC
Create your CSC account: <https://my.csc.fi/create-account>


It's possible that you have to make Haka authentication before creating the account. Is so: Select **Haka** as an authentication provider and in the next view choose **HAAGA-HELIA University of Applied Sciences** in the dropdown menu.
...
Give your Haaga-Helia credentials when prompted (bxx000 + password). 
CSC is using Multi-Factor authentication so you have to verify your login with the CSC MFA Authentication key. 
<p float="left"> 
  <img src="./imgs/CSC MFA Authentication.png" width="400" alt="Give digits"/> 
</p>
After authentication you will start to create a new profile to CSC’s platform. Match your selections to the image below and proceed to **Next step.**
...
Successful login will redirect you to CSC main page. 
