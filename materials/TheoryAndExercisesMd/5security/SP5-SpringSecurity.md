...
- WebSecurityConfig class contains a method 'passwordEncoder'. This method registers a password encoder as a Spring-managed bean so Spring Security can use it to hash and verify passwords
...
4. Create some demo users to your database in `CommandLineRunner`. **Hint:** You can use Bcrypt calculators to create hashed passwords.
