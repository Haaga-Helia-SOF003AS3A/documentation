...
- POM.XML: insert validation dependency 
...
- Controller: Add new arguments to controller request method. BindingResult object is used to check validation result. `@Valid` attribute gather attributes filled out in the form.
