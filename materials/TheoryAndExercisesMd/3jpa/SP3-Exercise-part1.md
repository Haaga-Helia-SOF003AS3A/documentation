...
1. Add support for JPA, H2 database and H2-console to your bookstore project by modifying pom.xml file.
...
4. Add CrudRepository BookRepository for JPA to work
5. Add command line runner to insert few example data to your database
6. Modify properties to show SQL statements in the console
7. Enable H2 console
