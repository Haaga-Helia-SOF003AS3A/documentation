...
2. Create similar software as booklist from previous week, but make it use MySQL. Make the software about customers instead of books. Customer has name and email.
