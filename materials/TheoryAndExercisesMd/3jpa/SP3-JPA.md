...
- The other properties can be left unannotated. Then these properties: are mapped to columns that share the same name as properties itself
...
- If you need to run some specific code when the SpringApplication has started, you can implement the `CommandLineRunner` interfaces. This is good place to add some demo data to your application
...
- Adding Create functionality to a Spring Boot application
