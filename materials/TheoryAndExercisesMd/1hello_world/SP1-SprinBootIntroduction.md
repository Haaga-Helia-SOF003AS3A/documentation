...
- Web application typically contains object that have dependencies to each others
...
- `@RequestMapping("*")` means for any path in the application will execute hello() method.
