...
2. Projektin tietojen syöttäminen:
  ...
  - ctrl + shift + p näppäinyhdistelmällä saat vs code ruudun yläreunaan command valikon -> kirjoita sinne ”Spring initializer: Create a Maven project”
  - Valitse SB versio on 4.0.1
  ...
  - Javan versio on 17
  - Valitse dependencyt (riippuvuudet, kirjastopaketit) ja hyväksy ne enterillä
...
- ctrl + shift + p näppäinyhdistelmällä saat vs code ruudun yläreunaan command valikon -> kirjoita sinne ”Spring initializer: Create a Maven project”
- Valitse opettajan ohjeistama Spring boot versio 
...
- Valitse paketointityypiksi JAR
- Javan versio on 17
- Valitse oikeat dependencyt (Spring web, Spring Boot Dev Tools)
